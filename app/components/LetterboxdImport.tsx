                            ...
                            .map((movie) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`group relative aspect-[2/3] rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 w-full text-left ${alreadyAdded && !canToggleSeen ? 'opacity-60 cursor-default' : 'hover:-translate-y-1'
                                            }`}
                                                ...
                                                <div className="flex flex-col gap-1.5 w-full max-h-[60%] overflow-y-auto">
                                                    {existingMovie.movieViews?.map((movieView) => {
                                                        ...
                                                        return (
                                                            <span
                                                                key={viewer.id}
                                                                className={`px-2 py-1 text-xs font-semibold rounded-md border backdrop-blur-sm ${hasSeen
